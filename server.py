...
#WHAT DO WE NAME THE END OF THE FILE PATH INSTEAD OF "w4111"????
...
#Maurice: GET ALL OF ZANE'S SQL CODE AND INPUT IT INTO THESE ENGINE.EXECUTE FUNCTIONS
...
#Maurice: This is the pre-GET request, used to connect to the database (like connecting to server in lab7)
@app.before_request
def before_request():
  """
...
#MAURICE: Read this below! Explains the top @approute thing!
...
@app.route('/')
def index():
#Maurice: these objects are used to gather information about the HTML GET request coming from the browser
	  #we aren't requesting anything
  """
  ...
  #Maurice: since this is on the index page, this is the query that will be made immediately when you first hit the site
...
#Maurice: Terra's example of a search query
...
#What does this piece of code mean? What is __name__ and __main__?
